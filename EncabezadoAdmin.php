...
<br>
  ...
  <section>
            <h3 class="slogan" style="color: #ffff; text-align:left;" aling="top"><img class="logo" src="img/Mialvatado.png" height="250px" alt=""> <img class="letras" src="img/AAAAA.png" alt=""></h3>
        </section>
</header>